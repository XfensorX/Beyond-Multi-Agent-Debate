...
class ChangedPromptMaDebateConfiguration(BaseModelWithExtraFields):
...
@register_decision_scheme("changed_prompt_mad")
class ChangedPromptMaDebate(DecisionScheme[ChangedPromptMaDebateConfiguration]):
